...
/**
 * Unit tests for [ArrayBinarySearchTree].
 */
internal class ArrayBinarySearchTreeTest {
    private lateinit var tree: ArrayBinarySearchTree<Int>

    @BeforeTest
    fun before() {
        tree = ArrayBinarySearchTree()
        tree.insert(2)
        tree.insert(1)
        tree.insert(3)
    }
